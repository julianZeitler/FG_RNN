...
for l = bPrs.minLevel:bPrs.maxLevel        
    for  ori = 1:bPrs.numOri
        ...
        Norm1_1 = params.bPrs.exp_decay + params.bPrs.FF.inhibition * imfilter(cPyr(l).orientation(ori).data, params.bPrs.FB.spatial_neighborhood) + params.bPrs.FB.inhibition * imfilter(bPyr1_2(l).orientation(ori).data, params.bPrs.FB.spatial_neighborhood); % Denominator
        ...
        Norm1_2 = params.bPrs.exp_decay + params.bPrs.FF.inhibition * imfilter(cPyr(l).orientation(ori+8).data, params.bPrs.FB.spatial_neighborhood) + params.bPrs.FB.inhibition * imfilter(bPyr1_1(l).orientation(ori).data, params.bPrs.FB.spatial_neighborhood); % Denominator
        ...
        Norm2_1 = params.bPrs.exp_decay + params.bPrs.FF.inhibition * imfilter(cPyr(l).orientation(ori+8).data, params.bPrs.FB.spatial_neighborhood) + params.bPrs.FB.inhibition * imfilter(bPyr2_2(l).orientation(ori).data, params.bPrs.FB.spatial_neighborhood); % Denominator
        ...
        Norm2_2 = params.bPrs.exp_decay + params.bPrs.FF.inhibition * imfilter(cPyr(l).orientation(ori).data, params.bPrs.FB.spatial_neighborhood) + params.bPrs.FB.inhibition * imfilter(bPyr2_1(l).orientation(ori).data, params.bPrs.FB.spatial_neighborhood); % Denominator
