...
for ori=1:params.B.numOri   
    ...
    Norm1 = params.B.exp_decay + params.B.FF.inhibition * imfilter(E.orientation(ori).data, params.B.FF.spatial_neighborhood_inh) + params.B.FB.inhibition * imfilter(B2.orientation(ori).data, params.B.FB.spatial_neighborhood) + params.B.saturation * (P1 + D1);
    ...
    Norm2 = params.B.exp_decay + params.B.FF.inhibition * imfilter(E.orientation(ori).data, params.B.FF.spatial_neighborhood_inh) + params.B.FB.inhibition * imfilter(B1.orientation(ori).data, params.B.FB.spatial_neighborhood) + params.B.saturation * (P2 + D2);
